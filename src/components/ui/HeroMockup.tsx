...
export default function HeroMockup() {
  return (
    <div className="relative w-full h-[340px] md:h-[400px] select-none flex items-center justify-center">
      <div className="relative w-full max-w-[430px] h-full origin-center scale-[0.78] sm:scale-[0.9] md:scale-100">
        {cards.map((card, i) => {
