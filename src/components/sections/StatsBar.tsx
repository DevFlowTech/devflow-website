...
const stats = [
  // ponytail: stats set to honest, defensible numbers per founding date Jan 2026.
  // Ceiling: update these from real tracked metrics as the business grows.
  {
    value: 12,
    suffix: "+",
    ...
    icon: (
      ...
      >
        <path
          ...
          strokeWidth={1.5}
          d="M15.5 14h.01M12 14h.01M8.5 14h.01M16 5V4a1 1 0 00-1-1H9a1 1 0 00-1 1v1M5 5h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2z"
        />
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={1.5}
          d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 002 2h2m.314-7.435A9 9 0 0120 13v1a2 2 0 01-2 2h-2v1a2 2 0 01-2 2v3m-3-4H8a2 2 0 00-2 2v3M3 12a9 9 0 019-9 9 9 0 019 9 9 9 0 01-9 9 9 9 0 01-9-9z"
        />
      </svg>
    ),
  },
