...
export const siteContent: ContentEntry[] = [
  ...
  {
    id: "blog/nodejs-microservices-architecture-github",
    title: "Nodejs Microservices Architecture Github: Enterprise Architecture & Implementation Guide",
    type: "blog",
    summary: "A technical engineering blueprint for nodejs microservices architecture github: architecture patterns, performance benchmarks, cost ROI, and production best practices.",
    keywords: [
  ...
  {
    id: "blog/serverless-architecture-vs-microservices",
    title: "Serverless Architecture Vs Microservices: In-Depth Technical & Cost Comparison (2026)",
    type: "blog",
    summary: "A technical engineering blueprint for serverless architecture vs microservices: architecture patterns, performance benchmarks, cost ROI, and production best practices.",
    keywords: [
    ...
    path: "/blog/serverless-architecture-vs-microservices",
    icon: "📝",
  },
  {
    id: "blog/serverless-computing-vs-microservices",
    title: "Serverless Computing Vs Microservices: In-Depth Technical & Cost Comparison (2026)",
    type: "blog",
    summary: "A technical engineering blueprint for serverless computing vs microservices: architecture patterns, performance benchmarks, cost ROI, and production best practices.",
    keywords: [
    ...
    path: "/blog/serverless-computing-vs-microservices",
    icon: "📝",
  },
  {
    id: "blog/serverless-architecture-and-microservices",
    title: "Serverless Architecture And Microservices: Enterprise Architecture & Implementation Guide",
    type: "blog",
    summary: "A technical engineering blueprint for serverless architecture and microservices: architecture patterns, performance benchmarks, cost ROI, and production best practices.",
    keywords: [
  ...
  {
    id: "blog/autonomous-agents-in-ai",
    title: "Autonomous Agents In Ai: Enterprise Architecture & Implementation Guide",
    type: "blog",
    summary: "A technical engineering blueprint for autonomous agents in ai: architecture patterns, performance benchmarks, cost ROI, and production best practices.",
    keywords: [
