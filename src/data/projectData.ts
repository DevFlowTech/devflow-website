...
export const projects: Project[] = [
  {
    ...
    description:
      "Engineered an AI-driven automated booking and hospital operations dashboard.",
    longDescription:
      "Developed to address critical hospital operational challenges, this custom AI system eliminates manual queues and patient scheduling bottlenecks. Our AI-driven automated booking and hospital operations dashboard integrates seamlessly with existing healthcare ERPs.",
    tech: ["React.js", "Node.js", "AI", "SaaS"],
    color: "from-devflow-green/20 to-devflow-green/5",
    accent: "#0225dc",
    url: "#",
    challenge:
      "Manual hospital queues and patient scheduling administrative bottlenecks.",
    solution:
      "Engineered an AI-driven automated booking and hospital operations dashboard.",
    results: [
  ...
  },
  {
    ...
    description:
      "Designed a database system powered by Cloudflare D1 and static assets.",
    longDescription:
      "Addressing high latency on real estate listing pages, we engineered a scalable SaaS web application. By leveraging Cloudflare D1 and optimized static assets, this custom real estate platform delivers sub-second page loads.",
    tech: ["HTML5", "JavaScript", "Cloudflare D1"],
    color: "from-blue-500/20 to-blue-500/5",
    accent: "#3b82f6",
    url: "#",
    challenge:
      "High latency and slow rendering times on real estate listing pages.",
    solution:
      "Designed a database system powered by Cloudflare D1 and static assets.",
    results: [
  ...
  },
  {
    ...
    url: "#",
    challenge:
      "Inaccurate, time-consuming lead extraction from map directories.",
    solution:
      "Custom Puppeteer scraping automation with multi-threaded node scripts.",
    results: [
  ...
  },
  {
    ...
    solution:
      "Dynamic tracking portal featuring real-time custom declarations.",
    results: ["Average logistics dispatch delay reduced by 35% across Europe."],
  },
  {
    ...
    url: "#",
    challenge:
      "Manual filtering of thousands of resumes against complex job roles.",
    solution:
      "Parser powered by Gemini 1.5 Pro to parse and match candidate profiles.",
    results: ["Increased recruitment processing speed by 80%."],
  },
  {
    ...
    url: "#",
    challenge:
      "High bounce rate on slow-loading international Shopify checkouts.",
    solution:
      "Next.js headless frontend integration using GraphQL and localized translations.",
    results: ["Mobile conversion rate increased by 22%."],
  },
  {
    ...
    url: "#",
    challenge:
      "Scattered fleet route telemetry and tracking for driver dispatch.",
  ...
  },
  {
    ...
    url: "#",
    challenge:
      "Catalog desynchronization between supplier and retail frontends.",
    solution:
      "High-frequency web automation crawler powered by Puppeteer and Redis.",
    results: ["Processed 500,000+ daily catalog items with zero API blocks."],
  },
  {
    ...
    url: "#",
    challenge:
      "Complex tax logic and failed recurring payments for multi-tenant users.",
    solution: "Developed a billing engine with robust Stripe webhook handlers.",
    results: ["Reduced payment churn by 18% globally."],
  },
  {
    ...
    results: ["Maintained 100% availability during 100k+ visitor spikes."],
  },
  {
    ...
    results: ["Latency reduced to under 50ms for live ticker charts."],
  },
  {
    ...
    solution:
      "Connected IoT hardware nodes to an MQTT broker and React dashboard.",
    results: ["Spot vacancy visibility increased to 98% efficiency."],
  },
  {
    ...
    url: "#",
    challenge:
      "Vulnerable entry logs and slow verification for visitor access.",
    solution:
      "Developed visitor verification using Kotlin and Supabase db logs.",
    results: ["Visitor verification time reduced to under 8 seconds."],
  },
  {
    ...
    url: "#",
    challenge:
      "Unsecured REST endpoints and slow lookup operations for large teams.",
    solution: "MERN Stack with JWT Auth and optimized database indexing.",
    results: ["Database query lookup speeds improved by 70%."],
  },
  {
    ...
    url: "#",
    challenge:
      "Delayed visa application processing and complex client document uploads.",
    solution:
      "Secure document parsing portal with React and Node upload pipelines.",
    results: ["Client onboarding time reduced by 40%."],
  },
  {
    ...
    results: ["Inventory stock accuracy improved to 99.8%."],
  },
  {
    ...
    solution:
      "Developed expense tracking tool with real-time budget forecasting.",
    results: ["Cost overruns reduced by 15% across projects."],
  },
  {
    ...
    solution:
      "GMB automation tool with Python scraping and Google Search API nodes.",
    results: ["Daily keyword ranking updates automated for 50+ locations."],
  },
  {
    slug: "vassu-infotech",
    ...
    results: ["PageSpeed index score increased to 99/100."],
  },
  {
    ...
    results: ["Monthly leads increased by 28%."],
  },
  {
    ...
    results: ["Audited 10,000+ pages instantly, boosting SEO workflow."],
  },
];
