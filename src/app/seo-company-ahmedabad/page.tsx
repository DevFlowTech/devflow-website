...
import { HiMapPin, HiPhone, HiEnvelope, HiShieldCheck, HiStar, HiArrowRight, HiCpuChip, HiSparkles, HiArrowPath, HiMagnifyingGlass, HiChatBubbleLeftRight, HiBolt, HiChartBar, HiShieldExclamation, HiGlobeAlt, HiCog, HiMagnifyingGlass as HiSearch } from "react-icons/hi2";
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative aspect-square rounded-2xl overflow-hidden border border-white/[0.06] bg-devflow-black p-8 flex flex-col justify-between group hover:border-devflow-green/20 transition-all">
              ...
              <div className="flex justify-between items-start z-10">
                <span className="text-xs font-mono text-devflow-green">[ GOOGLE MAPS 3-PACK ]</span>
