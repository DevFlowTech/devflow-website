...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "enterprise software development",
    "custom CRM system architect",
    "custom ERP portal engineer",
    "SaaS framework developer",
    "AI automation solutions provider",
    "React engineering studio India",
    "NextJS edge speed deployment",
    ...
    "mobile app development company Gandhinagar",
