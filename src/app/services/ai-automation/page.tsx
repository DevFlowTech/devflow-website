...
import { FiCpu, FiCheck, FiPlayCircle, FiTrendingUp } from "react-icons/fi";
    ...
    <main className="min-h-screen bg-devflow-black text-white pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="section-container max-w-4xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="glass-panel p-8 rounded-2xl">
            <h2 className="text-xl font-display font-medium text-white mb-4 flex items-center gap-2">
              <FiPlayCircle className="text-devflow-green" /> Key Capabilities
            </h2>
            <ul className="space-y-4 text-sm text-devflow-gray-300 font-light">
              <li className="flex items-start gap-2.5">
                ...
                Custom LLM models &amp; RAG implementations for document search.
              </li>
              <li className="flex items-start gap-2.5">
                <FiCheck className="text-devflow-green w-4 h-4 mt-0.5 flex-shrink-0" />
                Puppeteer automated multi-threaded scrapers with Redis queues.
              </li>
              <li className="flex items-start gap-2.5">
                <FiCheck className="text-devflow-green w-4 h-4 mt-0.5 flex-shrink-0" />
                API integrations connecting supplier catalogs to storefronts.
              </li>
            </ul>
          </div>
          ...
          <div className="glass-panel p-8 rounded-2xl">
            ...
            <div className="flex flex-wrap gap-2">
              {["Puppeteer", "Gemini API", "OpenAI API", "Python", "Redis", "Node.js", "MongoDB"].map((t) => (
        ...
        <div className="glass-panel p-8 rounded-2xl bg-gradient-to-br from-devflow-green/[0.03] to-transparent text-center space-y-6">
          ...
          <h3 className="text-xl font-display font-medium text-white">Automate Your Operations</h3>
          <p className="text-xs text-devflow-gray-400 max-w-md mx-auto">
            Get in touch to deploy high-frequency scrapers or autonomous AI workflow integrations.
          </p>
