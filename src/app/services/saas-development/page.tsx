...
import { FiLayout, FiCheck, FiCpu, FiTrendingUp } from "react-icons/fi";
    ...
    <main className="min-h-screen bg-devflow-black text-white pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="section-container max-w-4xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="glass-panel p-8 rounded-2xl">
            <h2 className="text-xl font-display font-medium text-white mb-4 flex items-center gap-2">
              <FiLayout className="text-devflow-green" /> Key Capabilities
            </h2>
            <ul className="space-y-4 text-sm text-devflow-gray-300 font-light">
              <li className="flex items-start gap-2.5">
                ...
                Multi-tenant database isolation &amp; row-level security.
              </li>
              <li className="flex items-start gap-2.5">
                <FiCheck className="text-devflow-green w-4 h-4 mt-0.5 flex-shrink-0" />
                Stripe billing system integration (recurring payments, metered billing, invoices).
              </li>
              <li className="flex items-start gap-2.5">
                <FiCheck className="text-devflow-green w-4 h-4 mt-0.5 flex-shrink-0" />
                Custom admin dashboard interface designs for usage tracking.
              </li>
            </ul>
          </div>
          ...
          <div className="glass-panel p-8 rounded-2xl">
            ...
            <div className="flex flex-wrap gap-2">
              {["Next.js 16", "React 19", "TypeScript", "Node.js", "Stripe API", "PostgreSQL", "AWS"].map((t) => (
        ...
        <div className="glass-panel p-8 rounded-2xl bg-gradient-to-br from-devflow-green/[0.03] to-transparent text-center space-y-6">
          ...
          <h3 className="text-xl font-display font-medium text-white">Ready to Build Your SaaS Product?</h3>
          <p className="text-xs text-devflow-gray-400 max-w-md mx-auto">
            Schedule a free engineering consultation with Prince &amp; Bhavin to scope your technical requirements.
          </p>
          <div className="flex justify-center gap-4">
            ...
            <Link href="/contact" className="px-5 py-3 border border-white/10 hover:border-white/20 text-white font-semibold text-xs rounded-xl hover:scale-105 transition-transform duration-200">
              ESTIMATE COST &rarr;
            </Link>
          </div>
        </div>
