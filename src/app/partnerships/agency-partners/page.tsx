...
export const metadata: Metadata = {
  ...
  description:
    "Strategic partnerships for digital marketing agencies, UI/UX design studios, and IT consultancies to deliver joint custom software systems.",
  alternates: {
      ...
      <div className="section-container max-w-4xl mx-auto space-y-12 relative z-10">
        ...
        <div className="space-y-4 border-b border-white/[0.08] pb-8">
          ...
          <p className="text-base text-devflow-gray-300 font-light leading-relaxed">
            Partner with DevFlow to deliver high-complexity software
            engineering, AI automation, and custom ERP systems to your agency
            clients.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl glass-panel border border-white/[0.06] space-y-3">
            <span className="text-xs font-mono text-devflow-green">
              [ DESIGN AGENCIES ]
            </span>
            ...
            <p className="text-xs text-devflow-gray-300 font-light leading-relaxed">
              Transform your client Figma designs into production Next.js and
          ...
          <div className="p-6 rounded-2xl glass-panel border border-white/[0.06] space-y-3">
            ...
            <p className="text-xs text-devflow-gray-300 font-light leading-relaxed">
              Fix deep Core Web Vitals, SSR rendering, and JSON-LD schema debt
              for client portals.
            </p>
          </div>
          <div className="p-6 rounded-2xl glass-panel border border-white/[0.06] space-y-3">
            ...
            <p className="text-xs text-devflow-gray-300 font-light leading-relaxed">
              Build custom ERPs, CRMs, and AI search engines mapped to your
              client audit recommendations.
            </p>
          </div>
        </div>
